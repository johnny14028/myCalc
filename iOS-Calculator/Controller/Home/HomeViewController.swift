...
final class HomeViewController: UIViewController {
    ...
    @IBOutlet weak var opertorPercent: UIButton!
    ...
    override func viewDidLoad() {
        ...
        //Obtenemos el total almacenado en memoria
        total = UserDefaults.standard.double(forKey: kTotal)
        //Arrancamos el result inicialmente para que cargue el dato inicial calculado
        result()
    }
    ...
    @IBAction func opertorPercentAction(_ sender: UIButton) {
